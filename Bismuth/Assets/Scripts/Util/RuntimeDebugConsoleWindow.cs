...
public class RuntimeDebugConsoleWindow : MonoBehaviour
{
    ...
    private void DrawToolbar(DebugConsoleManager manager)
    {
        ...
        if (GUILayout.Button(typeButtonLabel, _toolbarButtonStyle, GUILayout.Width(160)))
    ...
    private void DrawGameObjectNode(DebugConsoleManager manager, GameObject go, int depth)
    {
        ...
        GUILayout.BeginHorizontal(GetHierarchyRowStyle(isObjectFocused, isComponentParentFocused, false), GUILayout.Height(24f));
    ...
    private void DrawLogEntry(DebugEntry entry, int index)
    {
