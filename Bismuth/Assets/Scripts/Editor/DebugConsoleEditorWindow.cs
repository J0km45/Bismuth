...
{
    private const string PrefKeyPrefix = "DebugConsole.EditorWindow";
    ...
    private void DrawToolbarInfoGroup(DebugConsoleManager manager, bool expanded)
    {
        ...
        GUILayout.Space(8f);
        GUILayout.Label($"Count : {GetVisibleEntryCount(manager)}", _toolbarInfoLabelStyle, GUILayout.Width(expanded ? 120f : 110f), GUILayout.MinHeight(expanded ? 30f : 18f));
    }
