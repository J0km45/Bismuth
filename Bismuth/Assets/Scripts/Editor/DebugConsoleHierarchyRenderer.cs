...
public sealed class DebugConsoleHierarchyRenderContext
{
...
public static class DebugConsoleHierarchyRenderer
{
    public static void Draw(DebugConsoleHierarchyRenderContext ctx)
    {
    ...
    private static void DrawFooter(DebugConsoleHierarchyRenderContext ctx)
    {
    ...
    private static void DrawGameObjectNode(DebugConsoleHierarchyRenderContext ctx, GameObject go, int depth)
    {
    ...
    private static float GetHierarchyRowContentWidth(DebugConsoleHierarchyRenderContext ctx)
    {
    ...
    private static float GetHierarchyTextButtonWidth(DebugConsoleHierarchyRenderContext ctx, float rowContentWidth, float leadingSpace, bool reserveToggle, bool reserveFoldout)
    {
