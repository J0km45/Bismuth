...
public sealed class DebugConsoleLogRenderContext
{
...
public static class DebugConsoleLogRenderer
{
    public static void Draw(DebugConsoleLogRenderContext ctx)
    {
    ...
    private static float DrawLogEntry(DebugConsoleLogRenderContext ctx, DebugEntry entry, int index, float width)
    {
